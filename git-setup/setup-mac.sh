...
# ---------------------------------------------------
run "コミットテンプレート" git config --local commit.template git-setup/COMMIT_TEMPLATE
...
# ---------------------------------------------------
run "core.hooksPath" git config --local core.hooksPath git-setup/hooks
...
# ---------------------------------------------------
run "fetch.prune" git config --local fetch.prune true
...
# ---------------------------------------------------
run "pull.ff" git config --local pull.ff only
...
# ---------------------------------------------------
run "merge.ff" git config --local merge.ff false
...
# ---------------------------------------------------
run "core.autocrlf" git config --local core.autocrlf false
...
# ---------------------------------------------------
run "core.safecrlf" git config --local core.safecrlf warn
